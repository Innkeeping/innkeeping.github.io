...
var UniversalAdapterClient = class {
  constructor(options) {
    ...
    this.networkControllerClient = {
      ...
      getApprovedCaipNetworksData: async () => {
        ...
        const approvedCaipNetworkIds = WcHelpersUtil.getChainsFromNamespaces((_a = provider.session) == null ? void 0 : _a.namespaces);
        return Promise.resolve({
          supportsAllNetworks: false,
          approvedCaipNetworkIds
        });
    ...
    this.connectionControllerClient = {
      connectWalletConnect: async (onUri) => {
        ...
        if (ChainController.state.activeChain && ((_c = (_b = (_a = ChainController.state) == null ? void 0 : _a.chains) == null ? void 0 : _b.get(ChainController.state.activeChain)) == null ? void 0 : _c.adapterType) === "wagmi") {
          ...
          await ((_e = (_d = adapter == null ? void 0 : adapter.connectionControllerClient) == null ? void 0 : _d.connectWalletConnect) == null ? void 0 : _e.call(_d, onUri));
          ...
          const clientId = await ((_j = (_i = (_h = WalletConnectProvider == null ? void 0 : WalletConnectProvider.client) == null ? void 0 : _h.core) == null ? void 0 : _i.crypto) == null ? void 0 : _j.getClientId());
          if (clientId) {
            (_k = this.appKit) == null ? void 0 : _k.setClientId(clientId);
          }
          if (siweConfig && isSiweEnabled && siweParams && isProviderSupported && isSiweParamsValid && ChainController.state.activeChain === ConstantsUtil.CHAIN.EVM) {
            const { SIWEController, getDidChainId, getDidAddress } = await import("./exports-IETPJSYL.js");
            const chains = (_l = this.caipNetworks) == null ? void 0 : _l.filter((network) => network.chainNamespace === ConstantsUtil.CHAIN.EVM).map((chain) => chain.caipNetworkId);
            siweParams.chains = (_m = this.caipNetworks) == null ? void 0 : _m.filter((network) => network.chainNamespace === ConstantsUtil.CHAIN.EVM).map((chain) => chain.id);
            const result = await WalletConnectProvider.authenticate({
              nonce: await ((_n = siweConfig == null ? void 0 : siweConfig.getNonce) == null ? void 0 : _n.call(siweConfig)),
              methods: [...OPTIONAL_METHODS],
              ...siweParams,
              chains
            });
            const signedCacao = (_o = result == null ? void 0 : result.auths) == null ? void 0 : _o[0];
            if (signedCacao) {
      ...
      disconnect: async () => {
        ...
        (_c = this.appKit) == null ? void 0 : _c.resetAccount(ConstantsUtil.CHAIN.EVM);
        (_d = this.appKit) == null ? void 0 : _d.resetAccount(ConstantsUtil.CHAIN.SOLANA);
      },
    ...
    ChainController.subscribeKey("activeCaipNetwork", (val) => {
      var _a;
      const caipAddress = (_a = this.appKit) == null ? void 0 : _a.getCaipAddress(this.chainNamespace);
      if (val && caipAddress) {
  ...
  async disconnect() {
    ...
    if (this.walletConnectProvider) {
      ...
      (_a = this.appKit) == null ? void 0 : _a.resetAccount(ConstantsUtil.CHAIN.EVM);
      (_b = this.appKit) == null ? void 0 : _b.resetAccount(ConstantsUtil.CHAIN.SOLANA);
    }
  }
  ...
  async syncBalance(address, caipNetwork) {
    var _a, _b;
    const isExistingNetwork = (_a = this.appKit) == null ? void 0 : _a.getCaipNetworks(caipNetwork.chainNamespace).find((network) => network.id === caipNetwork.id);
    if (caipNetwork && isExistingNetwork) {
      try {
        ...
        (_b = this.appKit) == null ? void 0 : _b.setBalance((balance == null ? void 0 : balance.quantity.numeric) || "0", caipNetwork.nativeCurrency.symbol, this.chainNamespace);
      } catch (error) {
  ...
  async initWalletConnectProvider(projectId) {
    ...
    this.walletConnectProvider = await dr.init(walletConnectProviderOptions);
  ...
  setWalletConnectProvider() {
    ...
    if (nameSpaces) {
      ...
      reversedChainNamespaces.forEach((chainNamespace) => {
        var _a2, _b2, _c;
        const caipAddress = (_a2 = nameSpaces == null ? void 0 : nameSpaces[chainNamespace]) == null ? void 0 : _a2.accounts[0];
        ...
        (_b2 = this.appKit) == null ? void 0 : _b2.setApprovedCaipNetworksData(chainNamespace);
        if (caipAddress) {
          (_c = this.appKit) == null ? void 0 : _c.setCaipAddress(caipAddress, chainNamespace);
        }
      });
      ...
      try {
        ...
        } else if (!activeCaipNetwork || !ChainController.getAllApprovedCaipNetworkIds().includes(activeCaipNetwork.caipNetworkId)) {
  ...
  async watchWalletConnect() {
    ...
    const chainChanged = (chainId) => {
      ...
      if (!caipNetwork) {
        const namespace = ((_b = this.appKit) == null ? void 0 : _b.getActiveChainNamespace()) || ConstantsUtil.CHAIN.EVM;
    ...
    if (isConnected) {
      namespaceKeys.forEach(async (key) => {
        ...
        if (!isNamespaceConnected) {
          ...
          await Promise.all([(_e = this.appKit) == null ? void 0 : _e.setApprovedCaipNetworksData(chainNamespace)]);
        }
        this.syncAccounts();
      });
    } else {
      (_c = this.appKit) == null ? void 0 : _c.resetWcConnection();
      (_d = this.appKit) == null ? void 0 : _d.resetNetwork(this.chainNamespace);
  ...
  syncConnectedWalletInfo() {
    ...
    chainNamespaces.forEach((chainNamespace) => {
      ...
      if ((_a2 = this.walletConnectProvider) == null ? void 0 : _a2.session) {
        ...
        (_d = this.appKit) == null ? void 0 : _d.setConnectedWalletInfo({ name: currentActiveWallet }, ConstantsUtil.CHAIN.EVM);
        (_e = this.appKit) == null ? void 0 : _e.setConnectedWalletInfo({ name: currentActiveWallet }, ConstantsUtil.CHAIN.SOLANA);
      }
    });
  }
  syncConnectors() {
...
var AppKit = class {
  ...
  initializeUniversalAdapter(options) {
    ...
    (_b = (_a = this.universalAdapter).construct) == null ? void 0 : _b.call(_a, this, extendedOptions);
  }
  initializeAdapters(options) {
    ...
    (_a = options.adapters) == null ? void 0 : _a.forEach((adapter) => {
      var _a2;
      (_a2 = adapter.construct) == null ? void 0 : _a2.call(adapter, this, extendedOptions);
    });
  }
  setDefaultNetwork() {
    const previousNetwork = SafeLocalStorage.getItem(SafeLocalStorageKeys.ACTIVE_CAIP_NETWORK_ID);
    const caipNetwork = previousNetwork ? this.caipNetworks.find((n) => n.caipNetworkId === previousNetwork) : void 0;
  ...
  async initOrContinue() {
    if (!this.initPromise && !isInitialized && CoreHelperUtil.isClient()) {
      ...
      this.initPromise = new Promise(async (resolve) => {
        await Promise.all([
          import("./esm-PIBLD6U3.js"),
          import("./w3m-modal-OEI36GLV.js")
        ]);
...
var W3mConnectInjectedWidget = class W3mConnectInjectedWidget2 extends LitElement {
  ...
  render() {
    ...
    return html`
      ...
      if (!walletRDNS && !ConnectionController.checkInstalled(void 0, connector.chain)) {
        this.style.cssText = `display: none`;
        return null;
      }
...
//# sourceMappingURL=chunk-CWXS7TMC.js.map
