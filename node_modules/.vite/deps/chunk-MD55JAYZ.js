...
var ConnectorController = {
  ...
  setConnectors(connectors) {
    const newConnectors = connectors.filter((newConnector) => {
      ...
      return !state8.allConnectors.some((existingConnector) => existingConnector.id === newConnector.id && this.getConnectorName(existingConnector.name) === this.getConnectorName(newConnector.name) && existingConnector.chain === newConnector.chain);
    });
    state8.allConnectors = [...state8.allConnectors, ...newConnectors];
  ...
  mergeMultiChainConnectors(connectors) {
    ...
    connectorsByNameMap.forEach((keyConnectors) => {
      ...
      const isAuthConnector = (firstItem == null ? void 0 : firstItem.id) === "w3mAuth";
  ...
  getAuthConnector() {
    ...
    const authConnector = state8.connectors.find((c) => c.id === "w3mAuth");
    if (!authConnector) {
      return void 0;
    }
...
var ConnectionController = {
  ...
  async connectWalletConnect() {
    ...
    if (CoreHelperUtil.isTelegram()) {
      ...
      wcConnectionPromise = new Promise(async (resolve, reject) => {
        var _a7, _b4, _c2, _d2;
        await ((_d2 = (_c2 = (_b4 = (_a7 = ChainController.state) == null ? void 0 : _a7.universalAdapter) == null ? void 0 : _b4.connectionControllerClient) == null ? void 0 : _c2.connectWalletConnect) == null ? void 0 : _d2.call(_c2, (uri) => {
          state9.wcUri = uri;
      ...
      await ((_d = (_c = (_b3 = (_a6 = ChainController.state) == null ? void 0 : _a6.universalAdapter) == null ? void 0 : _b3.connectionControllerClient) == null ? void 0 : _c.connectWalletConnect) == null ? void 0 : _d.call(_c, (uri) => {
        state9.wcUri = uri;
        state9.wcPairingExpiry = CoreHelperUtil.getPairingExpiry();
      }));
    }
  ...
  async initializeSWIXIfAvailable() {
    ...
    const client = this._getClient(network == null ? void 0 : network.chainNamespace);
    try {
...
var SwapController = {
  ...
  async createAllowanceTransaction() {
    ...
    try {
      ...
      state11.swapTransaction = void 0;
      state11.approvalTransaction = transaction;
      return transaction;
    } catch (error) {
      RouterController.goBack();
...
var ChainController = {
  ...
  initialize(adapters) {
    ...
    if ((adapters == null ? void 0 : adapters.length) === 0) {
      state14.noAdapters = true;
    }
    if (!state14.noAdapters) {
      state14.activeChain = adapterToActivate == null ? void 0 : adapterToActivate.chainNamespace;
      PublicStateController.set({ activeChain: adapterToActivate == null ? void 0 : adapterToActivate.chainNamespace });
      adapters.forEach((adapter) => {
        state14.chains.set(adapter.chainNamespace, {
  ...
  initializeUniversalAdapter(adapter, adapters) {
    var _a6, _b3;
    state14.universalAdapter = adapter;
    if (adapters.length === 0) {
      const storedCaipNetwork = StorageUtil.getStoredActiveCaipNetwork();
      try {
        if (storedCaipNetwork) {
          state14.activeChain = storedCaipNetwork.chainNamespace;
        } else {
          state14.activeChain = ((_a6 = adapter == null ? void 0 : adapter.defaultNetwork) == null ? void 0 : _a6.chainNamespace) ?? ((_b3 = adapter.caipNetworks[0]) == null ? void 0 : _b3.chainNamespace);
        }
      } catch (error) {
  ...
  setChainAccountData(chain, accountProps, replaceState = true) {
    ...
    if (chainAdapter) {
      ...
      if (replaceState || state14.chains.size === 1 || state14.activeChain === chain) {
  ...
  addCaipNetwork(caipNetwork) {
    ...
    (_a6 = state14.chains.get(caipNetwork.chainNamespace)) == null ? void 0 : _a6.caipNetworks.push(caipNetwork);
  },
  ...
  getNetworkControllerClient(chainNamespace) {
    ...
    const universalNetworkControllerClient = state14.universalAdapter.networkControllerClient;
    const shouldUseUniversalAdapter = isWcConnector || state14.noAdapters;
  ...
  getConnectionControllerClient(_chain) {
    ...
    const universalConnectionControllerClient = state14.universalAdapter.connectionControllerClient;
    const hasWagmiAdapter = ((_a6 = state14.chains.get("eip155")) == null ? void 0 : _a6.adapterType) === "wagmi";
    const shouldUseUniversalAdapter = isWcConnector && !hasWagmiAdapter || state14.noAdapters;
    if (shouldUseUniversalAdapter) {
...
lit-html/development/directives/ref.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-MD55JAYZ.js.map
